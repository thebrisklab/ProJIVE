...
Y_1=t(as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_Y_1.txt',sep=''))))
Y_2=t(as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_Y_2.txt',sep=''))))
...
write.table(output,file=paste('siml2_seed',seed,'_p900_angle45_nstd1_DISCO.txt',sep=''),row.names = FALSE,col.names = FALSE)
...
write.table(nlogP,file=paste('siml2_seed',seed,'_p900_angle45_nstd1_DISCO_nlogP.txt',sep=''),row.names = FALSE,col.names = FALSE)

...
pmse.plot.20 = gg.pmse.plot(sim.20.gg$PMSEs, cbPalette[2:7], text.size = 15, lty = 1.5, show.legend = TRUE, y.max = 1.5)
...
# score.plot.20 = gg.score.norm.plot(sim.20.scores, cbPalette[2:7], text.size = 15, show.legend = TRUE)
# load.plot.20 = gg.load.norm.plot(sim.20.loads, cbPalette[2:7], text.size = 15, show.legend = TRUE)
# 
...
#############################Make Plots and Images    ########################################################################
##############################################################################################################################
AllSims200 = cbind(sim.results.005005, sim.results.05005, sim.results.00505, sim.results.0505)
AllSims200[,"Indiv.Var.Exp.X"] = 0.25
AllSims200[,"Indiv.Var.Exp.Y"] = 0.25
AllSims200.rows = rbind(sim.results.005005, sim.results.05005, sim.results.00505, sim.results.0505)
...
norm.plot.200 = gg.norm.plot.2(sim.200.gg.data, cbPalette[2:7], text.size = 15, show.legend = TRUE)
pmse.plot.200 = gg.pmse.plot(sim.200.gg$PMSEs, cbPalette[2:7], text.size = 15, lty = 1.5, show.legend = TRUE, y.max = 1.5)
...
# score.plot.200 = gg.score.norm.plot(sim.200.scores, cbPalette[2:7], text.size = 15, show.legend = TRUE)
# load.plot.200 = gg.load.norm.plot(sim.200.loads, cbPalette[2:7], text.size = 15, show.legend = TRUE)
# 
...
norm.plot.200 = gg.norm.plot.2(sim.200.gg.data, cbPalette[2:7], text.size = 9)
...
pdf(file = file.path(results.dir_n1000_rJ3, paste0("MR_ScoreAndLoading_NormPlots_", today(), ".pdf")), width = 5.5, height = 6)
plot_grid(plot_grid(norm.plot.20 , norm.plot.200, ncol = 1, align = 'v', labels = "AUTO"), 

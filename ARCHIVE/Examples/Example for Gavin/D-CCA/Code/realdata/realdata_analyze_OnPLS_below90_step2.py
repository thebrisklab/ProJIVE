...
for i in np.arange(1,11):
    for j in range(11):
        for k in range(11):
            cv_scores[i-1,j,k] = np.loadtxt('OnPLS_below90_CVscore_common' + str(i) + '_distinct' + str(j) + 'and' + str(k) + '.txt')
...
np.savetxt('C_1_hat_OnPLS_below90.txt', C_1_onpls, delimiter=' ')
np.savetxt('C_2_hat_OnPLS_below90.txt', C_2_onpls, delimiter=' ')

np.savetxt('D_1_hat_OnPLS_below90.txt', D_1_onpls, delimiter=' ')
np.savetxt('D_2_hat_OnPLS_below90.txt', D_2_onpls, delimiter=' ')

np.savetxt('X_1_hat_OnPLS_below90.txt', X_1_onpls, delimiter=' ')
np.savetxt('X_2_hat_OnPLS_below90.txt', X_2_onpls, delimiter=' ')
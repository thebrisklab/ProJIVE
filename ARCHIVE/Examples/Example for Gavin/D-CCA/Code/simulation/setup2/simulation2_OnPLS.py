...
Y_1 = np.loadtxt('/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed'+seed+'_p900_angle45_nstd1_Y_1.txt')
Y_2 = np.loadtxt('/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed'+seed+'_p900_angle45_nstd1_Y_2.txt')
...
X_1 = np.loadtxt('/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed'+seed+'_p900_angle45_nstd1_X_1.txt')
X_2 = np.loadtxt('/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed'+seed+'_p900_angle45_nstd1_X_2.txt')

C_1 = np.loadtxt('/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed'+seed+'_p900_angle45_nstd1_C_1.txt')
C_2 = np.loadtxt('/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed'+seed+'_p900_angle45_nstd1_C_2.txt')
...
np.savetxt('siml2_seed'+seed+'_p900_angle45_nstd1_OnPLS.txt', output, delimiter=' ')
...
np.savetxt('siml2_seed'+seed+'_p900_angle45_nstd1_OnPLS_nlogP.txt', nlogP, delimiter=' ')

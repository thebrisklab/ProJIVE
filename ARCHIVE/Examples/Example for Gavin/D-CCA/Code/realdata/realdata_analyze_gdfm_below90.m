...
save(['chi_xy1_below90.txt'],'chi_xy1','-ascii');
save(['chi_y1_below90.txt'],'chi_y1','-ascii');
save(['phi_y1_below90.txt'],'phi_y1','-ascii');
save(['psi_y1_below90.txt'],'psi_y1','-ascii');
save(['nu_y1_below90.txt'],'nu_y1','-ascii');
save(['xi_xy1_below90.txt'],'xi_xy1','-ascii');

save(['chi_xy2_below90.txt'],'chi_xy2','-ascii');
save(['chi_y2_below90.txt'],'chi_y2','-ascii');
save(['phi_y2_below90.txt'],'phi_y2','-ascii');
save(['psi_y2_below90.txt'],'psi_y2','-ascii');
save(['nu_y2_below90.txt'],'nu_y2','-ascii');
save(['xi_xy2_below90.txt'],'xi_xy2','-ascii');

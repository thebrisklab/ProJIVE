...
np.savetxt('siml2_seed' + sys.argv[1] + '_p' + str(p_1) + '_angle' + str(angle_deg) + '_nstd' + str(std_noise)  +'_Y_1.txt', Y_1, delimiter=' ')
np.savetxt('siml2_seed' + sys.argv[1] + '_p' + str(p_1) + '_angle' + str(angle_deg) + '_nstd' + str(std_noise)  +'_Y_2.txt', Y_2, delimiter=' ')

np.savetxt('siml2_seed' + sys.argv[1] + '_p' + str(p_1) + '_angle' + str(angle_deg) + '_nstd' + str(std_noise)  +'_X_1.txt', X_1, delimiter=' ')
np.savetxt('siml2_seed' + sys.argv[1] + '_p' + str(p_1) + '_angle' + str(angle_deg) + '_nstd' + str(std_noise)  +'_X_2.txt', X_2, delimiter=' ')
 
np.savetxt('siml2_seed' + sys.argv[1] + '_p' + str(p_1) + '_angle' + str(angle_deg) + '_nstd' + str(std_noise)  +'_C_1.txt', C_1, delimiter=' ')
np.savetxt('siml2_seed' + sys.argv[1] + '_p' + str(p_1) + '_angle' + str(angle_deg) + '_nstd' + str(std_noise)  +'_C_2.txt', C_2, delimiter=' ')

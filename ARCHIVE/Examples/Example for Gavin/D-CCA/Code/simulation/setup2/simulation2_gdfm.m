function simulation2_gdfm(seed_i)
...
for theta_i=1:2
  ...
  Y_1=load(['/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed',seed,'_p900_angle',theta,'_nstd1_Y_1.txt']);
  Y_2=load(['/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed',seed,'_p900_angle',theta,'_nstd1_Y_2.txt']);
  
  X_1=load(['/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed',seed,'_p900_angle',theta,'_nstd1_X_1.txt']);
  X_2=load(['/scratch/hshu/paper1_revision/setup2/datafile/siml2_seed',seed,'_p900_angle',theta,'_nstd1_X_2.txt']);
  ...
  save(['siml2_seed', seed, '_p900_angle',theta,'_nstd1_gdfm.txt'],'output','-ascii');
  ...
  save(['siml2_seed', seed, '_p900_angle',theta,'_nstd1_gdfm_nlogP_1.txt'],'nlogP','-ascii');
  ...
  save(['siml2_seed', seed, '_p900_angle',theta,'_nstd1_gdfm_nlogP_2.txt'],'nlogP','-ascii');

...
pdf(file = file.path(results.dir_n1000_rJ1, paste0("GG_rJ1_ScoreAndLoading_NormPlots_", today(), ".pdf")), width = 5.5, height = 6)
...
pdf(file = file.path(results.dir_n1000_rJ1, paste0("GG_rJ1_ScoreAndLoading_PMSEPlots_", today(), ".pdf")), width = 5.5, height = 6)
...
# score.plot.200 = gg.score.pmse.plot(sim.200.scores, cbPalette[7:2], text.size = 9, show.legend = TRUE)
# load.plot.200 = gg.load.pmse.plot(sim.200.loads, cbPalette[7:2], text.size = 9, show.legend = TRUE)
# 
# plot.name = paste("GG_SimBin_n1000_rJ3_P120_p2200_ScoreAndLoadNormPlots_wLegend", Sys.Date(), ".pdf", sep = "")
# pdf(file = file.path(imgs.fldr_n1000_rJ3, plot.name))
# gg.norm.plot.2(sim.200.gg.data, cbPalette[7:2], text.size = 15, show.legend = TRUE)
# dev.off()
# 
...
# sim.loads = sim.gg.data[grep("Loadings", sim.gg.data[,"Type"]),]
# 
# norm.plot = gg.norm.plot.2(sim.gg.data, cbPalette[7:2], text.size = 15, show.legend = TRUE)
# score.plot = gg.score.norm.plot(sim.scores, cbPalette[7:2], text.size = 15, show.legend = TRUE)
# load.plot = gg.load.norm.plot(sim.loads, cbPalette[7:2], text.size = 15, show.legend = TRUE)
# 

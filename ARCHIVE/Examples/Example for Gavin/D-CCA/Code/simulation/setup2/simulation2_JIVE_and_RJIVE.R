...
Y_1=as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_Y_1.txt',sep='')))
Y_2=as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_Y_2.txt',sep='')))

X_1=as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_X_1.txt',sep='')))
X_2=as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_X_2.txt',sep='')))

C_1=as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_C_1.txt',sep='')))
C_2=as.matrix(read.table(paste('/rsrch2/biostatistics/hshu/paper1/simulation1/setup2_paper_revision2/data/datafile/siml2_seed',seed,'_p900_angle45_nstd1_C_2.txt',sep='')))
...
write.table(output,file=paste('siml2_seed',seed,'_p900_angle45_nstd1_JIVE.txt',sep=''),row.names = FALSE,col.names = FALSE)
...
write.table(nlogP,file=paste('siml2_seed',seed,'_p900_angle45_nstd1_JIVE_nlogP.txt',sep=''),row.names = FALSE,col.names = FALSE)
...
write.table(output,file=paste('siml2_seed',seed,'_p900_angle45_nstd1_RJIVE.txt',sep=''),row.names = FALSE,col.names = FALSE)
...
write.table(nlogP,file=paste('siml2_seed',seed,'_p900_angle45_nstd1_RJIVE_nlogP.txt',sep=''),row.names = FALSE,col.names = FALSE)

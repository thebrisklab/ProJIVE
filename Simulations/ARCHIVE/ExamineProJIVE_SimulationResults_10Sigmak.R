...
results.dir_rJ3 = "H:/My Documents/P-JIVE/Results/Simulation_Results/JointRank3_GaussGauss_n1000_sigk10"
...
plot.name = paste("SimBin_rJ3_P120_P220_ScoreAndLoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
print(norm.plot)
dev.off()

plot.name = paste("SimBin_rJ3_P120_P220_ScoreAndLoadNormPlots_wLegend", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
gg.norm.plot(sim.gg.data, cb.cols, text.size = 15, show.legend = TRUE)
dev.off()

plot.name = paste("SimBin_rJ3_P120_P220_ScorePlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
print(score.plot)
dev.off()

plot.name = paste("SimBin_rJ3_P120_P220_LoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
print(load.plot)
dev.off()
########################################################################################################################
...
plot.name = paste("SimBin_rJ3_P120_P2200_ScoreAndLoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
print(norm.plot)
dev.off()

plot.name = paste("SimBin_rJ3_P120_P2200_ScoreAndLoadNormPlots_wLegend", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
gg.norm.plot(sim.gg.data, cb.cols, text.size = 15, show.legend = TRUE)
dev.off()

plot.name = paste("SimBin_rJ3_P120_P2200_ScorePlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
print(score.plot)
dev.off()

plot.name = paste("SimBin_rJ3_P120_P2200_LoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ3, plot.name))
print(load.plot)
dev.off()
################################################################################################################################
...
plot.name = paste("SimBin_rJ1_P120_P220_ScoreAndLoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
print(norm.plot)
dev.off()

plot.name = paste("SimBin_rJ1_P120_P220_ScoreAndLoadNormPlots_wLegend", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
gg.norm.plot(sim.gg.data, cb.cols, text.size = 15, show.legend = TRUE)
dev.off()

plot.name = paste("SimBin_rJ1_P120_P220_ScorePlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
print(score.plot)
dev.off()

plot.name = paste("SimBin_rJ1_P120_P220_LoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
print(load.plot)
dev.off()
########################################################################################################################
...
plot.name = paste("SimBin_rJ1_P120_P2200_ScoreAndLoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
print(norm.plot)
dev.off()

plot.name = paste("SimBin_rJ1_P120_P2200_ScoreAndLoadNormPlots_wLegend", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
gg.norm.plot(sim.gg.data, cb.cols, text.size = 15, show.legend = TRUE)
dev.off()

plot.name = paste("SimBin_rJ1_P120_P2200_ScorePlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
print(score.plot)
dev.off()

plot.name = paste("SimBin_rJ1_P120_P2200_LoadNormPlots", Sys.Date(), ".pdf", sep = "")
pdf(file = file.path(imgs.fldr_rJ1, plot.name))
print(load.plot)
dev.off()
